...
import { RaijinLabsLucidAiDefaultError } from "../models/errors/raijinlabslucidaidefaulterror.js";
...
export function match<T, E>(
...
): MatchFunc<T, E | RaijinLabsLucidAiDefaultError | ResponseValidationError> {
  return async function matchFunc(
    ...
    [
      result: Result<
        T,
        E | RaijinLabsLucidAiDefaultError | ResponseValidationError
      >,
      raw: unknown,
    ]
  > {
    ...
    if (!matcher) {
      return [{
        ok: false,
        error: new RaijinLabsLucidAiDefaultError(
    ...
    if (matcher.enc === "fail") {
      return [{
        ok: false,
        error: new RaijinLabsLucidAiDefaultError("API error occurred", {
          request,
          response,
          body,
        }),
