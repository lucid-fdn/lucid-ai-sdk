 ...
 */
export function chainsLucidListChains(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidListChainsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidListChainsResponse$inboundSchema),
