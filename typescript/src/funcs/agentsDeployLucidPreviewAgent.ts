 ...
 */
export function agentsDeployLucidPreviewAgent(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidPreviewAgentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidPreviewAgentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidPreviewAgentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/agents/preview")();
  ...
  const context = {
    ...
    operationID: "lucid_preview_agent",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidPreviewAgentResponse$inboundSchema),
