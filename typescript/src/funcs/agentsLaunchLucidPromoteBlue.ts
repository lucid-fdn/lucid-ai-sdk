...
export function agentsLaunchLucidPromoteBlue(
  ...
  Result<
    operations.LucidPromoteBlueResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidPromoteBlueRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "lucid_promote_blue",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidPromoteBlueResponse$inboundSchema),
