 ...
 */
export function healthLucidCheckReadiness(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidCheckReadinessResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_check_readiness",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidCheckReadinessResponse$inboundSchema),
