 ...
 */
export function agentsWalletLucidAgentWalletSend(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidAgentWalletSendRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidAgentWalletSendResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidAgentWalletSendRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/agents/{agentId}/wallet/send")(pathParams);
  ...
  const context = {
    ...
    operationID: "lucid_agent_wallet_send",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidAgentWalletSendResponse$inboundSchema),
