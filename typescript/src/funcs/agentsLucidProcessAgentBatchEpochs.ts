 ...
 */
export function agentsLucidProcessAgentBatchEpochs(
  client: RaijinLabsLucidAiCore,
  request: models.AgentBatchEpochsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidProcessAgentBatchEpochsResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_process_agent_batch_epochs",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidProcessAgentBatchEpochsResponse$inboundSchema),
