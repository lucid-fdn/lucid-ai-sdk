...
export function agentsLaunchLucidDeployBlueGreen(
  ...
  Result<
    operations.LucidDeployBlueGreenResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidDeployBlueGreenRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "lucid_deploy_blue_green",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.LucidDeployBlueGreenResponse$inboundSchema),
