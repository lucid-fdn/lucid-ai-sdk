 ...
 */
export function paymentsLucidSubscribeAsset(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidSubscribeAssetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidSubscribeAssetResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidSubscribeAssetRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "lucid_subscribe_asset",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidSubscribeAssetResponse$inboundSchema),
