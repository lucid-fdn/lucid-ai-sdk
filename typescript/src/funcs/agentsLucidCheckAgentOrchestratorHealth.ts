 ...
 */
export function agentsLucidCheckAgentOrchestratorHealth(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidCheckAgentOrchestratorHealthResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_check_agent_orchestrator_health",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.LucidCheckAgentOrchestratorHealthResponse$inboundSchema,
    ),
