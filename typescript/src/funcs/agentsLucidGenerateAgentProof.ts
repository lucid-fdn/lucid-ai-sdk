 ...
 */
export function agentsLucidGenerateAgentProof(
  client: RaijinLabsLucidAiCore,
  request: models.AgentProofRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGenerateAgentProofResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_generate_agent_proof",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGenerateAgentProofResponse$inboundSchema),
