 ...
 */
export function agentsLucidVerifyAgentMmr(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidVerifyAgentMmrRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidVerifyAgentMmrResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidVerifyAgentMmrRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "lucid_verify_agent_mmr",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidVerifyAgentMmrResponse$inboundSchema),
