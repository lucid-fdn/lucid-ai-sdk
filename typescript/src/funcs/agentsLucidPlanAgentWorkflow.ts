 ...
 */
export function agentsLucidPlanAgentWorkflow(
  client: RaijinLabsLucidAiCore,
  request: models.AgentPlanRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidPlanAgentWorkflowResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_plan_agent_workflow",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidPlanAgentWorkflowResponse$inboundSchema),
