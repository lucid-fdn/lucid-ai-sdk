 ...
 */
export function healthLucidCheckLiveness(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidCheckLivenessResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_check_liveness",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidCheckLivenessResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
