 ...
 */
export function agentsLucidGetPlannerInfo(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetPlannerInfoResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_get_planner_info",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetPlannerInfoResponse$inboundSchema),
