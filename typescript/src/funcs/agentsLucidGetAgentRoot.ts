 ...
 */
export function agentsLucidGetAgentRoot(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidGetAgentRootRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetAgentRootResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidGetAgentRootRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "lucid_get_agent_root",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetAgentRootResponse$inboundSchema),
