 ...
 */
export function healthLucidGetDetailedHealth(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetDetailedHealthResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_get_detailed_health",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetDetailedHealthResponse$inboundSchema),
