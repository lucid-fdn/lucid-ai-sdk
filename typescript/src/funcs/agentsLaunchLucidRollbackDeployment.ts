 ...
 */
export function agentsLaunchLucidRollbackDeployment(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidRollbackDeploymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidRollbackDeploymentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidRollbackDeploymentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/agents/{passportId}/rollback")(pathParams);
  ...
  const context = {
    ...
    operationID: "lucid_rollback_deployment",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidRollbackDeploymentResponse$inboundSchema),
