 ...
 */
export function paymentsLucidSetDefaultFacilitator(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LucidSetDefaultFacilitatorRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "lucid_set_default_facilitator",
    oAuth2Scopes: null,
