 ...
 */
export function reputationLucidGetCompositeReputation(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidGetCompositeReputationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetCompositeReputationResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LucidGetCompositeReputationRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/reputation/{agentId}/composite")(pathParams);
  ...
  const context = {
    ...
    operationID: "lucid_get_composite_reputation",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetCompositeReputationResponse$inboundSchema),
