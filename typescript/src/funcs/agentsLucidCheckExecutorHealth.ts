 ...
 */
export function agentsLucidCheckExecutorHealth(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidCheckExecutorHealthResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_check_executor_health",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidCheckExecutorHealthResponse$inboundSchema),
