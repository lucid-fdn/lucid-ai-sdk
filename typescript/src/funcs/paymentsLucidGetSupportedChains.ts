 ...
 */
export function paymentsLucidGetSupportedChains(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetSupportedChainsResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_get_supported_chains",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetSupportedChainsResponse$inboundSchema),
