 ...
 */
export function agentsLucidAccomplishAgentGoal(
  client: RaijinLabsLucidAiCore,
  request: models.AgentAccomplishRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidAccomplishAgentGoalResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_accomplish_agent_goal",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidAccomplishAgentGoalResponse$inboundSchema),
