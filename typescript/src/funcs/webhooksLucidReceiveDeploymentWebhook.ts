 ...
 */
export function webhooksLucidReceiveDeploymentWebhook(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidReceiveDeploymentWebhookRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidReceiveDeploymentWebhookResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LucidReceiveDeploymentWebhookRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/webhooks/{provider}")(pathParams);
  ...
  const context = {
    ...
    operationID: "lucid_receive_deployment_webhook",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidReceiveDeploymentWebhookResponse$inboundSchema),
