...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidDeleteA2aTaskRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "lucid_delete_a2a_task",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidDeleteA2aTaskResponse$inboundSchema),
