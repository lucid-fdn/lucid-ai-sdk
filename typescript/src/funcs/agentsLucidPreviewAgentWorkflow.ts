 ...
 */
export function agentsLucidPreviewAgentWorkflow(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidPreviewAgentWorkflowRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidPreviewAgentWorkflowResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LucidPreviewAgentWorkflowRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "lucid_preview_agent_workflow",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidPreviewAgentWorkflowResponse$inboundSchema),
