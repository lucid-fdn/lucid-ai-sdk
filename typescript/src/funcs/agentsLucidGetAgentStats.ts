 ...
 */
export function agentsLucidGetAgentStats(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidGetAgentStatsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetAgentStatsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidGetAgentStatsRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "lucid_get_agent_stats",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetAgentStatsResponse$inboundSchema),
