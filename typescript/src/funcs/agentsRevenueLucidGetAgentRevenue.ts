 ...
 */
export function agentsRevenueLucidGetAgentRevenue(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidGetAgentRevenueRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetAgentRevenueResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidGetAgentRevenueRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/agents/{agentId}/revenue")(pathParams);
  ...
  const context = {
    ...
    operationID: "lucid_get_agent_revenue",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetAgentRevenueResponse$inboundSchema),
