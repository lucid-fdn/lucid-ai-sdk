 ...
 */
export function agentsWalletLucidSetAgentWalletLimits(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidSetAgentWalletLimitsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidSetAgentWalletLimitsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LucidSetAgentWalletLimitsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/agents/{agentId}/wallet/limits")(pathParams);
  ...
  const context = {
    ...
    operationID: "lucid_set_agent_wallet_limits",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidSetAgentWalletLimitsResponse$inboundSchema),
