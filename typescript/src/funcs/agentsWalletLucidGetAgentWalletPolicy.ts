 ...
 */
export function agentsWalletLucidGetAgentWalletPolicy(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidGetAgentWalletPolicyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetAgentWalletPolicyResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LucidGetAgentWalletPolicyRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/agents/{agentId}/wallet/policy")(pathParams);
  ...
  const context = {
    ...
    operationID: "lucid_get_agent_wallet_policy",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetAgentWalletPolicyResponse$inboundSchema),
