 ...
 */
export function paymentsLucidGetPaymentConfig(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetPaymentConfigResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_get_payment_config",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetPaymentConfigResponse$inboundSchema),
