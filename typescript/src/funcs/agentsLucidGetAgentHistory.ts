 ...
 */
export function agentsLucidGetAgentHistory(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidGetAgentHistoryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetAgentHistoryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidGetAgentHistoryRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "lucid_get_agent_history",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetAgentHistoryResponse$inboundSchema),
