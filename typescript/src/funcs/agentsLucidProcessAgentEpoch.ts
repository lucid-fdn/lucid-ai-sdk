 ...
 */
export function agentsLucidProcessAgentEpoch(
  client: RaijinLabsLucidAiCore,
  request: models.AgentEpochRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidProcessAgentEpochResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_process_agent_epoch",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidProcessAgentEpochResponse$inboundSchema),
