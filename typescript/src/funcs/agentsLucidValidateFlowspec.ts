 ...
 */
export function agentsLucidValidateFlowspec(
  client: RaijinLabsLucidAiCore,
  request: { [k: string]: any },
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidValidateFlowspecResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "lucid_validate_flowspec",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidValidateFlowspecResponse$inboundSchema),
