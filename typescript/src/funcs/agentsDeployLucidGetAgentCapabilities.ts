 ...
 */
export function agentsDeployLucidGetAgentCapabilities(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidGetAgentCapabilitiesResponse,
...
> {
  const path = pathToFunc("/v1/agents/capabilities")();
  ...
  const context = {
    ...
    operationID: "lucid_get_agent_capabilities",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetAgentCapabilitiesResponse$inboundSchema),
