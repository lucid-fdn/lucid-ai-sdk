 ...
 */
export function reputationLucidListReputationAlgorithms(
  client: RaijinLabsLucidAiCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidListReputationAlgorithmsResponse,
...
> {
  const path = pathToFunc("/v2/reputation/algorithms")();
  ...
  const context = {
    ...
    operationID: "lucid_list_reputation_algorithms",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidListReputationAlgorithmsResponse$inboundSchema),
