 ...
 */
export function a2ALucidDiscoverA2aAgent(
  client: RaijinLabsLucidAiCore,
  request: operations.LucidDiscoverA2aAgentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidDiscoverA2aAgentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidDiscoverA2aAgentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/a2a/discover")();
  ...
  const context = {
    ...
    operationID: "lucid_discover_a2a_agent",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidDiscoverA2aAgentResponse$inboundSchema),
