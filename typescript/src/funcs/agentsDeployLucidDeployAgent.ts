 ...
 */
export function agentsDeployLucidDeployAgent(
  client: RaijinLabsLucidAiCore,
  request: models.DeployAgentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidDeployAgentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.DeployAgentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/agents/deploy")();
  ...
  const context = {
    ...
    operationID: "lucid_deploy_agent",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.LucidDeployAgentResponse$inboundSchema),
