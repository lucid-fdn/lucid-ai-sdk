 ...
 */
export function agentsLucidInitAgent(
  client: RaijinLabsLucidAiCore,
  request: models.AgentInitRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidInitAgentResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidInitAgentResponse$inboundSchema),
