 ...
 */
export function paymentsLucidCreatePaymentGrant(
  client: RaijinLabsLucidAiCore,
  request: models.CreatePaymentGrantRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidCreatePaymentGrantResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreatePaymentGrantRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/config/grants")();
  ...
  const context = {
    ...
    operationID: "lucid_create_payment_grant",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.LucidCreatePaymentGrantResponse$inboundSchema),
